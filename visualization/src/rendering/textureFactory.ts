...
/*  木纹纹理                                                            */
/* ================================================================== */
export function woodTexture(w = 256, h = 256, baseColor = '#b07c4f', isDark = false): HTMLCanvasElement {
...
/*  金属纹理                                                            */
/* ================================================================== */
export function metalTexture(w = 128, h = 128, baseColor = '#94a3b8', isDark = false): HTMLCanvasElement {
...
/*  大理石 / 实验台面纹理                                                */
/* ================================================================== */
export function marbleTexture(w = 256, h = 256, isDark = false): HTMLCanvasElement {
...
/*  地面 / 桌面纹理（实验台）                                            */
/* ================================================================== */
export function labBenchTexture(w = 512, h = 128, isDark = false): HTMLCanvasElement {
