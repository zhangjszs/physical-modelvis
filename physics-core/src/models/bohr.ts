...
export class BohrModel extends PhysicsModelBase {
    ...
    readonly assumptions = ['经典玻尔模型 (量子力学是更精确的图像)', '单电子氢原子', '电子轨道半径 r_n = n²·a₀'];
    ...
    solve(problem: PhysicsProblem): SimulationResult {
        ...
        const seriesNameZh =
            series === 'Lyman' ? '赖曼系 (紫外)' : series === 'Balmer' ? '巴尔末系 (可见)' : '帕邢系 (红外)';
            ...
            for (let nHigh = nLow + 1; nHigh <= maxN; nHigh++) {
                ...
                if (dE > 0) {
                    ...
                    if (nLow === 1) {
                        ...
                        seriesLabel = 'Balmer';
                        visible = lambdaNm >= 380 && lambdaNm <= 780;
                    } else if (nLow === 3) {
                        seriesLabel = 'Paschen';
                    }
                ...
                formulas: [
                    {
                        ...
                        variables: { 'E₁': { value: E1_eV, unit: 'eV' }, 'E∞': { value: 0, unit: 'eV' } }
                    },
                    {
                        name: '波长公式',
                        formula: '1/λ = R(1/n₁² − 1/n₂²)',
                        variables: { R: { value: R_inf, unit: 'm⁻¹' } }
                    }
                ]
            },
            errors: [],
