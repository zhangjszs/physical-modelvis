...
export class ElectrostaticInductionModel extends PhysicsModelBase {
  ...
  solve(problem: PhysicsProblem): SimulationResult {
    ...
    const qC_theta: ChartSeries = {
      xLabel: '距离 d_AC (cm)', yLabel: '箔片张角 θ (度)', xUnit: 'cm', yUnit: '°',
    ...
    return {
      ...
      explanation: {
        ...
        steps,
        formulas: [
          { name: '近端电荷', formula: 'q_near = −k_ind·Q_C/(d_AC+s)²', variables: { k_ind: { value: INDUCTION_K, unit: 'μC/cm²' }, Q_C: { value: chargeC, unit: 'μC' }, d: { value: distanceAC + separation, unit: 'cm' } } },
          { name: '远端电荷', formula: 'q_far = +k_ind·Q_C/d_AC²', variables: { d: { value: distanceAC, unit: 'cm' } } },
