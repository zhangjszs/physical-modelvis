...
export class DopplerModel extends PhysicsModelBase {
    ...
    readonly errorSources = ['实际声源/观察者可能同时运动', '风速影响等效声速', '当 v_s 接近 v 时形成冲击波'];
                ...
                formulas: [
                    {
                        ...
                        variables: {
                            v: { value: v, unit: 'm/s' },
                            v_s: { value: vs, unit: 'm/s' },
                            cosTheta: { value: cosTheta, unit: '' },
                            f_prime: { value: fObserved, unit: 'Hz' }
                        }
                    },
                    {
                        name: '拍频',
                        formula: 'f_beat = |f_prime - f|',
                        variables: { f_beat: { value: fBeat, unit: 'Hz' } }
                    }
                ]
            },
            errors: [],
