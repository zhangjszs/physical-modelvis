...
export class OilFilmModel extends PhysicsModelBase {
  ...
  solve(problem: PhysicsProblem): SimulationResult {
    ...
    const histogram: ChartSeries = {
      xLabel: '直径 d (10⁻¹⁰ m)', yLabel: '频率', xUnit: '10⁻¹⁰ m', yUnit: '次',
      points: [],
    };
    const nBins = 20;
    ...
    const concentrationCurve: ChartSeries = {
      xLabel: '浓度 (1:x)', yLabel: '直径 d (10⁻¹⁰ m)', xUnit: '', yUnit: '10⁻¹⁰ m',
      points: [],
    };
    const nScan = 30;
    ...
    return {
      ...
      explanation: {
        ...
        steps,
        formulas: [
          { name: '纯油酸体积', formula: 'V_oil = V_drop × drops / c', variables: { V_drop: { value: dropVolume, unit: 'mL' }, drops: { value: drops, unit: '滴' }, c: { value: concentration, unit: '1:x' } } },
          { name: '分子直径', formula: 'd = V_oil / S', variables: { V_oil: { value: vo, unit: 'm³' }, S: { value: S, unit: 'm²' }, d: { value: d, unit: 'm' } } },
        ],
      },
      errors: [],
      warnings,
