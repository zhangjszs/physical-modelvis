...
export class LiquidMixingModel extends PhysicsModelBase {
    ...
    readonly errorSources = ['收缩系数随组成非线性变化', '温度对氢键强度的影响', '微量杂质的影响'];
        ...
        return {
            ...
            explanation: {
                ...
                formulas: [
                    {
                        name: '混合前体积',
                        formula: 'V_total = V_w + V_a',
                        variables: { V_w: { value: Vw, unit: 'mL' }, V_a: { value: Va, unit: 'mL' } }
                    },
                    {
                        name: '体积收缩',
                        formula: 'V_f = V_w + V_a·(1-k·x_w)',
                        variables: { k: { value: k, unit: '' }, x_w: { value: xW, unit: '' } }
                    }
                ]
            },
            errors: [],
