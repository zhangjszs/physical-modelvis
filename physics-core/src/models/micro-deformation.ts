  ...
  solve(problem: PhysicsProblem): SimulationResult {
    ...
    return {
      ...
      explanation: {
        ...
        formulas: [
          { name: '微小形变', formula: 'Δh = F·L₀/(E·A)', variables: { 'F': { value: F, unit: 'N' }, 'L₀': { value: L0, unit: 'm' }, 'E': { value: E, unit: 'Pa' }, 'A': { value: A, unit: 'm²' } } },
          { name: '桌面倾角', formula: 'α ≈ Δh/L',            variables: { 'Δh': { value: deltaH, unit: 'm' }, 'L': { value: L, unit: 'm' } } },
          { name: '光点位移 (精确)', formula: 'Δs = 2D·tan(2α)',variables: { 'D': { value: D, unit: 'm' }, '2α': { value: 2 * alpha, unit: 'rad' } } },
          { name: '光点位移 (近似)', formula: 'Δs ≈ 4D·α',       variables: { 'D': { value: D, unit: 'm' }, 'α': { value: alpha, unit: 'rad' } } },
          { name: '放大倍数',     formula: 'k = Δs/Δh ≈ 4D/L',  variables: { 'D': { value: D, unit: 'm' }, 'L': { value: L, unit: 'm' } } },
          { name: '形变反推',     formula: 'Δh ≈ ΔsL/(4D)',      variables: { 'Δs': { value: deltaS, unit: 'm' }, 'L': { value: L, unit: 'm' }, 'D': { value: D, unit: 'm' } } },
        ],
      },
      renderHints: [
