...
export class AdiabaticCompressionModel extends PhysicsModelBase {
  ...
  solve(problem: PhysicsProblem): SimulationResult {
    ...
    const trajectory: TrajectoryPoint[] = [
      { t: 0, position: { x: V1 * 1e3, y: P1_STD / 1e3 }, velocity: { x: 0, y: 0 }, kineticEnergy: 0, potentialEnergy: 0 },
      { t: 0, position: { x: V2 * 1e3, y: p2 / 1e3 }, velocity: { x: 0, y: 0 }, kineticEnergy: 0, potentialEnergy: 0 },
    ];
