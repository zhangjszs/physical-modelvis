  ...
  solve(problem: PhysicsProblem): SimulationResult {
    ...
    return {
      ...
      explanation: {
        ...
        steps,
        formulas: [
          { name: '波长', formula: 'lambda = v/f', variables: { v: { value: v, unit: 'm/s' }, f: { value: f, unit: 'Hz' }, lambda: { value: lambda, unit: 'm' } } },
          { name: '干涉强度', formula: 'I = 4*I0*cos^2(pi*delta_r/lambda)', variables: { I_ratio: { value: I_ratio, unit: '' } } },
        ],
      },
      errors: [],
      warnings,
