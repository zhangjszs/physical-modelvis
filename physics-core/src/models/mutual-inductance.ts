  ...
  solve(problem: PhysicsProblem): SimulationResult {
    ...
    return {
      ...
      explanation: {
        ...
        steps,
        formulas: [
          { name: '互感', formula: 'M = k*sqrt(L1*L2)', variables: { k: { value: k, unit: '' }, L1: { value: L1, unit: 'H' }, L2: { value: L2, unit: 'H' }, M: { value: M, unit: 'H' } } },
          { name: '感生电动势', formula: 'E2 = -M*dI1/dt', variables: { M: { value: M, unit: 'H' }, dI1dt: { value: I0 * omega, unit: 'A/s' }, E2: { value: E2_amplitude, unit: 'V' } } },
        ],
      },
      errors: [],
      warnings,
