...
export class ResistanceLawModel extends PhysicsModelBase {
  ...
  solve(problem: PhysicsProblem): SimulationResult {
    ...
    const R_L: ChartSeries = {
      xLabel: '长度 L (m)', yLabel: '电阻 R (Ω)', xUnit: 'm', yUnit: 'Ω',
      points: [],
    };
    const lMin = lRange[0]!;
    const lMax = lRange[1]!;
    ...
    const R_invS: ChartSeries = {
      xLabel: '1/S (m⁻²)', yLabel: '电阻 R (Ω)', xUnit: 'm⁻²', yUnit: 'Ω',
      points: [],
    };
    ...
    const R_material: ChartSeries = {
      xLabel: '材料', yLabel: '电阻 R (Ω)', xUnit: '', yUnit: 'Ω',
      points: [],
    };
    ...
    return {
      ...
      explanation: {
        ...
        steps,
        formulas: [
          { name: '电阻定律', formula: 'R = ρ·L/S', variables: { ρ: { value: rho, unit: 'Ω·m' }, L: { value: L0, unit: 'm' }, S: { value: S0, unit: 'm²' }, R: { value: R0, unit: 'Ω' } } },
          { name: '横截面积', formula: 'S = πd²/4', variables: { d: { value: d0, unit: 'm' }, S: { value: S0, unit: 'm²' } } },
        ],
      },
      errors: [],
      warnings,
