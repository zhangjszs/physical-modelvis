                ...
                steps: [
                    {
                        ...
                        description: '近地圆轨道速度',
                        formula: 'v₁ = √(gR)',
                        calculation: `v₁ = √(9.8 × 6.371×10⁶) ≈ 7.9 km/s`,
                        result: '第一宇宙速度 ≈ 7.9 km/s (航天器入轨最低速度)'
                    },
                    {
                        order: 2,
                        description: '逃逸速度',
                        formula: 'v_e = √(2GM/r)',
                        calculation: `v_e = √(2×${GM.toExponential(2)}/${r0Mag.toExponential(2)})`,
                        result: `v_e = ${(vEscape / 1000).toFixed(2)} km/s`
                    },
                    {
                        order: 3,
                        description: '圆轨道周期',
                        formula: 'T = 2π√(r³/GM)',
                        calculation: `T = 2π√(${r0Mag.toExponential(2)}³/${GM.toExponential(2)})`,
                        result: `T = ${(TOrbit / 60).toFixed(1)} min`
                    },
                    {
                        order: 4,
                        description: '开普勒第二定律',
                        formula: '近地点速度大, 远地点速度小',
                        calculation: `v_max=${(maxV / 1000).toFixed(2)}km/s (近地点), v_min=${(minV / 1000).toFixed(2)}km/s (远地点)`
                    }
                ],
                formulas: [
                    ...
                    { name: '轨道速度', formula: 'v = √(GM/r)', variables: { v: { value: vOrbit, unit: 'm/s' } } },
                    {
                        name: '逃逸速度',
                        formula: 'v_e = √(2GM/r)',
                        variables: { v_e: { value: vEscape, unit: 'm/s' } }
                    },
