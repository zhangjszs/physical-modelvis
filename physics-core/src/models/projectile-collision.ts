...
export class ProjectileCollisionModel extends PhysicsModelBase {
  ...
  readonly requiredParameters: ParameterSpec[] = [
    ...
    { name: 'restitution', description: '弹性系数 e (1=完全弹性, 0=完全非弹性)', unit: '', required: false, min: 0, max: 1 },
    ...
    return {
      ...
      diagnostics: {
        ...
        maxValues: {
          ...
          pBefore, pAfter,
          momentumRelErr,
          KETotalBefore, KETotalAfter, KEloss,
        },
      ...
      explanation: {
        ...
        steps,
        formulas: [
          { name: '平抛时间', formula: 't_fall = sqrt(2h/g)', variables: { h: { value: h, unit: 'm' }, g: { value: g, unit: 'm/s^2' }, t_fall: { value: tFall, unit: 's' } } },
          { name: '动量守恒', formula: 'm1*v1 = m1*v1_prime + m2*v2_prime', variables: { m1: { value: m1, unit: 'kg' }, m2: { value: m2, unit: 'kg' } } },
