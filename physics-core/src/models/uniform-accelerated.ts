...
export class UniformAcceleratedModel extends PhysicsModelBase {
    ...
    readonly assumptions = ['物体视为质点', '加速度恒定', '沿直线运动 (一维或二维但加速度方向与速度方向共线)'];
    readonly applicableRange = '适用于加速度恒定的直线运动，如自由落体、刹车减速等';
    readonly errorSources = ['实际加速度可能因摩擦变化', '空气阻力会导致加速度不恒定'];
                ...
                steps: [
                    {
                        ...
                        description: '速度公式',
                        formula: 'v = v₀ + at',
                        calculation: `v = ${v0Mag.toFixed(2)} + ${aMag.toFixed(2)} × ${duration}`
                    },
                ...
                formulas: [
                    {
                        ...
                        formula: 'v = v₀ + at',
                        variables: {
                            'v₀': { value: v0Mag, unit: 'm/s' },
                            a: { value: aMag, unit: 'm/s²' },
                    ...
                    },
                    {
                        ...
                        formula: 'x = x₀ + v₀t + ½at²',
                        variables: {
                            'x₀': { value: Vec2.magnitude(x0), unit: 'm' },
                            'v₀': { value: v0Mag, unit: 'm/s' },
                            a: { value: aMag, unit: 'm/s²' },
                            t: { value: duration, unit: 's' }
                        }
                    },
                    {
                        name: '速度-位移公式',
                        formula: 'v² = v₀² + 2a(x - x₀)',
                        variables: { 'v₀': { value: v0Mag, unit: 'm/s' }, a: { value: aMag, unit: 'm/s²' } }
                    }
                ]
            },
            errors: [],
